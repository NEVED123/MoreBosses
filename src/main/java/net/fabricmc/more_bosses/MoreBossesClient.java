...
public class MoreBossesClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        EntityRendererRegistry.register(MoreBosses.ZOMBIE_SCARECROW_ENTITY, (context) -> {
        ...
        EntityRendererRegistry.register(MoreBosses.TOWER_OF_UNDYING_ENTITY, (context) -> {
        ...
        EntityRendererRegistry.register(MoreBosses.GIANT_ZOMBIE_BOSS_ENTITY, (context) -> {
        ...
        EntityRendererRegistry.register(MoreBosses.GIANT_PILLAGER_BOSS_ENTITY, (context) -> {
